...
<html>
    ...
    <body>
		...
		<div class="navbar-header">
                    <a class="navbar-brand" href="<?= site_url() ?>/home" role="home" target="content" id="tempat">NAN_NAN CAFE</a>
		</div>
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">	
                        <li><a href="<?= site_url() ?>/makanan_user" role="makanan_userlist" target="content" id="tempat">Makanan</a></li>
                        <li><a href="<?= site_url() ?>/minuman_user" role="minuman_userlist" target="content" id="tempat">Minuman</a></li>
                            ...
                            <li><a href="<?= site_url() ?>/login" role="login" target="content" id="tempat">Login</a></li>
